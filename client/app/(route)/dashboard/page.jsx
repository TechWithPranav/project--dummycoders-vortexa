// import Recommendations from "@/app/_components/cure/dashboard/recommendations";
...
//                         <Link href="/dashboard/ai" className="flex items-center justify-between w-full group p-4">
//                             <div className="space-y-0.5">
//                                 <h5 className="font-medium font-heading text-fuchsia-500">Virtual assistant</h5>
...
import Cards from "./_Charts/_Charts/Cards/Cards";
import { PieChartComponent } from "./_Charts/_Charts/piechart";
