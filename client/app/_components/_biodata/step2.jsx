...
const StepTwo = ({ nextStep }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    router.push("/biodata/stepthree");
  };


  const questions = [
    { id: "appetite", label: "Appetite Amount", options: ["High", "Mid", "Low", "Medium"] },
    { id: "appetiteFreq", label: "Appetite Frequency", options: ["Regualar", "Irregular"] },
    { id: "bladderFreq", label: "Bladder Frequency", options: ["Regular", "Irregular"] },
    { id: "bowelTendency", label: "Bowel Tendency", options: ["None", "Constipation", "Loose Motion"] },
    { id: "perspiration", label: "Perspiration", options: ["High", "Mid", "Low"] },
  ];

  return (
    <div className="flex flex-col items-center justify-center w-full max-w-2xl mx-auto h-full mt-10">
        <h2 className="text-3xl font-semibold text-center text-green-700 mb-5">Step Two</h2>
