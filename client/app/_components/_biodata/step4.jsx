...
const StepFour = ({ nextStep }) => {
  ...
  const questions = [
    { id: "bodyTemp", label: "Body Temperature", options: ["Low", "Mid", "High"] },
    { id: "skinPimples", label: "Skin Pimples", options: ["Yes", "No"] },
    { id: "skinWrinkles", label: "Skin Wrinkles", options: ["Yes", "No"] },
    { id: "anger", label: "Annger Quality", options: ["Good", "Medium", "Poor"] },
  ];

  return (
    <div className="flex flex-col items-center justify-center w-full max-w-2xl mx-auto h-full mt-10">
        <h2 className="text-3xl font-semibold text-center text-green-700 mb-5">Step Four</h2>
